...
pub const DELIST_ASSET_DISCRIMINATOR: [u8; 8] = [14, 118, 119, 59, 231, 94, 152, 172];

/// Accounts.
#[derive(Debug)]
pub struct DelistAsset {
...
impl DelistAsset {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = DelistAssetInstructionData::new().try_to_vec().unwrap();
...
pub struct DelistAssetInstructionData {
    discriminator: [u8; 8],
}

impl DelistAssetInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [14, 118, 119, 59, 231, 94, 152, 172],
        }
    }
...
impl Default for DelistAssetInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `DelistAsset`.
///
/// ### Accounts:
///
...
/// `delist_asset` CPI accounts.
pub struct DelistAssetCpiAccounts<'a, 'b> {
...
/// `delist_asset` CPI instruction.
pub struct DelistAssetCpi<'a, 'b> {
...
impl<'a, 'b> DelistAssetCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: DelistAssetCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `DelistAsset` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   7. `[]` mpl_core_program
#[derive(Clone, Debug)]
pub struct DelistAssetCpiBuilder<'a, 'b> {
    instruction: Box<DelistAssetCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DelistAssetCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DelistAssetCpiBuilderInstruction {
            __program: program,
            payer: None,
            owner: None,
            asset: None,
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = DelistAssetCpi {
...
#[derive(Clone, Debug)]
struct DelistAssetCpiBuilderInstruction<'a, 'b> {
