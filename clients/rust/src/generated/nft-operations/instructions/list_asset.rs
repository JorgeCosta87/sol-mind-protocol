...
pub const LIST_ASSET_DISCRIMINATOR: [u8; 8] = [11, 25, 254, 205, 61, 252, 23, 15];
...
impl ListAsset {
    pub fn instruction(&self, args: ListAssetInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = ListAssetInstructionData::new().try_to_vec().unwrap();
...
pub struct ListAssetInstructionData {
    discriminator: [u8; 8],
}

impl ListAssetInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [11, 25, 254, 205, 61, 252, 23, 15],
        }
    }
...
impl Default for ListAssetInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ListAssetInstructionArgs {
    pub price: u64,
}

impl ListAssetInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `ListAsset`.
///
/// ### Accounts:
///
...
impl ListAssetBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = ListAssetInstructionArgs {
...
/// `list_asset` CPI accounts.
pub struct ListAssetCpiAccounts<'a, 'b> {
...
/// `list_asset` CPI instruction.
pub struct ListAssetCpi<'a, 'b> {
    ...
    pub __args: ListAssetInstructionArgs,
}

impl<'a, 'b> ListAssetCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: ListAssetCpiAccounts<'a, 'b>,
        args: ListAssetInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ListAsset` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   7. `[]` mpl_core_program
#[derive(Clone, Debug)]
pub struct ListAssetCpiBuilder<'a, 'b> {
    instruction: Box<ListAssetCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ListAssetCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ListAssetCpiBuilderInstruction {
            __program: program,
            payer: None,
            owner: None,
            asset: None,
...
#[derive(Clone, Debug)]
struct ListAssetCpiBuilderInstruction<'a, 'b> {
